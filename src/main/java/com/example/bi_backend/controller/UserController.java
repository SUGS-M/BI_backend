...
import com.example.bi_backend.annotation.AuthCheck;
import com.example.bi_backend.common.BaseResponse;
import com.example.bi_backend.common.DeleteRequest;
...
public class UserController {
     ...
     */
    @PostMapping("/delete")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE) //toDo
